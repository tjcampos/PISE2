 ...
 *
 * Generated: 2009-12-12 15:58:09.532
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x09620000, LENGTH = 32
    onchip_mem : ORIGIN = 0x09620020, LENGTH = 8160
    sdram_u1 : ORIGIN = 0x04000000, LENGTH = 33554432
    sdram_u2 : ORIGIN = 0x06000000, LENGTH = 33554432
    ssram : ORIGIN = 0x09200000, LENGTH = 2097152
    cfi_flash : ORIGIN = 0x08800000, LENGTH = 8388608
}

    /* Define symbols for each memory base-address */
 __alt_mem_onchip_mem = 0x09620000 ;
 __alt_mem_sdram_u1 = 0x04000000 ;
 __alt_mem_sdram_u2 = 0x06000000 ;
 __alt_mem_ssram = 0x09200000 ;
 __alt_mem_cfi_flash = 0x08800000 ;
...
SECTIONS
{
    ...
    .text :
    {
        ...
        *(.dynamic)
        ...
        KEEP (*(.jcr))
        . = ALIGN(32 / 8);
    } >  sdram_u1 =0x3a880100 /* NOP on Nios2 (big endian) */
