...
#
# Generated: 2009-12-12 15:58:03.508
...
ptf=/home/tjcampos/tmp2/DE2_70_NET/DE2_70_SOPC.ptf
...
sidp=0x096411d0
id=1520569647u
timestamp=1195523523u

# Include operating system specific parameters, if they are supplied.

if test -f /opt/altera/nios2eds/components/altera_hal/build/os.sh ; then
   . /opt/altera/nios2eds/components/altera_hal/build/os.sh
fi
